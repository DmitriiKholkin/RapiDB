...
function getColoredServerIconUri(
  ...
  const svgIconDisconnected = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
    <path transform="translate(0,0.5)" fill="${safeHex}" d="M12 11.5a.5.5 0 1 1-1 0a.5.5 0 0 1 1 0M11.5 8a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1M14 4.5c-.001.37-.14.727-.39 1c.25.273.389.63.39 1v2c-.001.37-.14.727-.39 1c.25.273.389.63.39 1v2a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 12.5v-2c.001-.37.14-.727.39-1a1.5 1.5 0 0 1-.39-1v-2c.001-.37.14-.727.39-1a1.5 1.5 0 0 1-.39-1v-2A1.5 1.5 0 0 1 3.5 1h9A1.5 1.5 0 0 1 14 2.5zm-11 0a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5zM12.5 6h-9a.5.5 0 0 0-.5.5v2a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5m.5 4.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v2a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5zM11.5 4a.5.5 0 1 0 0-1a.5.5 0 0 0 0 1"/>
  </svg>`;
  const svgIconConnected = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
    ...
    <path transform="translate(0,0.5)" mask="url(#mask)" fill="${safeHex}" d="M3.5 1h9A1.5 1.5 0 0 1 14 2.5v2c-.25.273-.389.63-.39 1c.001.37.14.727.39 1v2c-.25.273-.389.63-.39 1c.001.37.14.727.39 1v2a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 12.5v-2c.25-.273.389-.63.39-1c-.001-.37-.14-.727-.39-1v-2c.25-.273.389-.63.39-1c-.001-.37-.14-.727-.39-1v-2A1.5 1.5 0 0 1 3.5 1z"/>
  </svg>`;
